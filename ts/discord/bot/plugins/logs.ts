...
function messageDelete(message: Discord.Message | Discord.PartialMessage) {
...
function messageUpdate(oldMessage: Discord.Message | Discord.PartialMessage, newMessage: Discord.Message | Discord.PartialMessage) {
