...
function showChannel(page: chatUtils.MessagePage, channelFeed: ChannelFeed) {
...
function showPageFeed(page: chatUtils.MessagePage, channelFeed: ChannelFeed, pos: number) {
