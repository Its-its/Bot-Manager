...
let Queue = require('../src/music/models/queue');

let config = require('../src/site/util/config');

mongoose.Promise = global.Promise;
mongoose.connect('mongodb://dev.local:27017/bot-manager');

console.log(Queue.collection.name);
Queue.count({}, (err, queue) => {
	console.log(queue);
});